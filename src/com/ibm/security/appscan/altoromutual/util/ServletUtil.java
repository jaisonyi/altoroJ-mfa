...
public class ServletUtil {
	...
	/* Multi-factor authentication (TOTP) - transient pre-authentication state.
	 * None of these grant access on their own; only SESSION_ATTR_USER does. */
	public static final String SESSION_ATTR_MFA_PENDING_USER = "mfaPendingUser";
	public static final String SESSION_ATTR_MFA_ENROLL_USER = "mfaEnrollUser";
	public static final String SESSION_ATTR_MFA_ENROLL_SECRET = "mfaEnrollSecret";
	public static final String SESSION_ATTR_MFA_ATTEMPTS = "mfaAttempts";
	public static final String SESSION_ATTR_MFA_ERROR = "mfaError";
